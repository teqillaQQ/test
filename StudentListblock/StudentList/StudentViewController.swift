...
class StudentViewController: UIViewController {
    ...
    var closures: ((String, Int, UIViewController) -> Void)?
...
//    weak var delegate: StudentViewControllerDelegate?
    ...
    @objc private func selectButtonTapped() {
        ...
        vc.closures = { [weak self] (_ student: String, gender: Int, sender: UIViewController) in
...
extension StudentViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        closures?(dataSource[indexPath.section][indexPath.row], indexPath.section, self)
        }
